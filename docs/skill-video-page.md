...
<div class="tab w-full overflow-hidden border-t"><div class=" flex flex-col space-y-4"><input class="absolute opacity-0 " id="tab-multi-one" type="checkbox" name="tabs"> <label class="block p-2 text-sm text-left rounded-md bg-green-600 cursor-pointer" for= "tab-multi-one"><span class="text-xm text-left"><b>①笑顔と心ある接遇</b></span></label> <div class="tab-content overflow-hidden  leading-normal">
