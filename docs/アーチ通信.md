...
<body class="p-20 space-y-"0>

<hr class="border-2 border-blue-500 border-blue-800 " />

<h2 class="text-blue-500 text-xl  font-bold">知って得する‼</h2>

<h2 class="text-blue-500 text-xl font-bold">～アーチ通信～</h2>
...
<span class="text-black-600 text-center text-sm font-bold">「ながらストレッチ」で腰痛予防！</span></div><hr class="border-2 border-blue-500 border-blue-800 " /><br>
