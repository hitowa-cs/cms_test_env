...
<span class="text-lg  font-bold text-left"><b> Case.４ スマホ型記録システムの試験導入</b></span>
...
<span class="text-sm text-left">2019.08より、記録システム「Notice」の試験導入を行っています。<br> スマホ型の記録システムで、その場で記録をする、確認することが特徴となっています。<br> 約10カ月の運用を経て、効果測定やスタッフアンケートを実施いたしました。</span>
...
<span class="text-sm text text-left">＜システム概要＞</span>
