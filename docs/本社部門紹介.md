...
<div class="bg-amber-200  text-align-left text-left bg-opacity-100 p-2 ml-8"><span class="<text-xl text-left text-black  ml-2 font-bolddecoration-solid underline-offset-1 ">■運営1課</span>：千葉第1、千葉第2エリア</span></div><br>
