...
<div class="align-middle text-sm md:text-base"

<span class="text-xs text-black text-center  text-base font-bold">問い合わせ先</span></div> ✉home-Test@Test.jp<br> 📞03-633-</p></div>
